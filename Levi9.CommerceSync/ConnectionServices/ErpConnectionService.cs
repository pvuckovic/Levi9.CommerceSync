...
namespace Levi9.CommerceSync
{
    public class ErpConnectionService : IErpConnectionService
    {
        ...
        public async Task<SyncResult<bool>> SyncProducts()
        {
            ...
            if (lastUpdate == null)
            {
                return new SyncResult<bool> { IsSuccess = true, Message = "SYNC: Last update not found." };
            }
            ...
            {
                return new SyncResult<bool> { IsSuccess = true, Message = "SYNC: There are no products to sync." };
            }
        ...
        private async Task<SyncResult<bool>> HandleNoClientsToSyncOnErp(string newLastUpdate, int erpClientsCount)
        {
            ...
            {
                return new SyncResult<bool> { IsSuccess = true, Message = "SYNC: There are no clients to sync." };
            }
